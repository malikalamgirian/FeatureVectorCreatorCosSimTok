...
//             Select "Tagged Strings"
            TaggedString1_NodeList = processed_Doc_Root.getElementsByTagName("TaggedString1");
            TaggedString2_NodeList = processed_Doc_Root.getElementsByTagName("TaggedString2");
            ...
            for (int i = 0; i < pairs_Of_UnProcessed_Doc.getLength(); i++) {
                 ...
                 */
                TaggedString1Str = TaggedString1_NodeList.item(i).getTextContent();
                TaggedString2Str = TaggedString2_NodeList.item(i).getTextContent();
                
                /*
                 * test
                 */
                System.out.println("Tagged1 : " + TaggedString1Str + " :: Tagged2 : " + TaggedString2Str + "\n");

                /*
                 * Create Node for CosineSimilarityTok
                 */
                CosineSimilarityTok_Element = unProcessed_Doc.createElement("CosineSimilarityTok");

                /*
                 * Calculate Raw Similarity
                 * using Standard similarity metrics
                 */
                 CosineSimilarityTok_Element.setTextContent(Float.toString((new CosineSimilarity()).getSimilarity(TaggedString1Str, TaggedString2Str)));
                 
                 /*
                  * Add pair
                  */
                pair_UnProcessed.appendChild(CosineSimilarityTok_Element);
    ...
    private void setFeature_Extracted_File_URL(Properties properties) throws Exception {
        ...
        try {
             ...
             */
            suffixToAdd = "cos_sim_tok_features_extracted";
