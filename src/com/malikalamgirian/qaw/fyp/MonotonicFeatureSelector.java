...
//             Get the required one
            CosineSimilarityTok_NodeList = root.getElementsByTagName("CosineSimilarityTok");
            ...
            for (int i = 0; i < pairs.getLength(); i++) {
                ...
                /*
                 * Extract CosineSimilarityTok value
                 */
                CosineSimilarityTok_String = CosineSimilarityTok_NodeList.item(i).getTextContent();
                ...
                if (i == 0) {
                     ...
                     * 
                     *
                     * String1Id,String2Id,CosineSimilarityTok,pair_Quality
                     */
                ...
                /*
                 * Cosine Similarity ... CosineSimilarityTok
                 */
                line_To_Insert_In_File = appendString(line_To_Insert_In_File, CosineSimilarityTok_String, feature_Separator_Char);
